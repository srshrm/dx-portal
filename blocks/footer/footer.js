...
const GLOBE_IMG = '<img class="footer-region-img" loading="lazy" src="globe.svg" alt="">';
const ADCHOICE_IMG = '<img class="footer-link-img"  alt= "" loading="lazy" src="adchoices-small.svg">';
...
async function fetchFooter(url) {
  //const resp = await fetch(`https://adobe.sharepoint.com/:w:/r/sites/dx-portal/_layouts/15/Doc.aspx?sourcedoc=%7BFA6D7DE6-251A-4A90-A88F-A8991A1CED2C%7D&file=footer.docx&action=default&mobileredirect=true.plain.html`);
